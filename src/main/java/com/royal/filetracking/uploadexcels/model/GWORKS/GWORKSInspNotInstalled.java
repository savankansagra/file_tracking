...
@Entity
@Table(name = "insp_not_installed")
public class GWORKSInspNotInstalled {
	...
	@Column(name = "not_installed_dt")
	private Date notInstalledDt;
	...
	@Column(name = "System_Not_Installed_Remarks")
	private String systemNotInstalledRemarks;
	...
	public Date getNotInstalledDt() {
		return notInstalledDt;
	}

	public void setNotInstalledDt(Date notInstalledDt) {
		this.notInstalledDt = notInstalledDt;
	}
	...
	public String getSystemNotInstalledRemarks() {
		return systemNotInstalledRemarks;
	}

	public void setSystemNotInstalledRemarks(String systemNotInstalledRemarks) {
		this.systemNotInstalledRemarks = systemNotInstalledRemarks;
	}
